                        ...
                        <li >
                            ...
                            {(toggleKey2) && <div>
                                <li>
                                    <label>
                                        <input type="checkbox"
                                            value="&price_greater_than=0&price_less_than=5"
                                            checked={selectedOption === "&price_greater_than=0&price_less_than=5"}
                                            onChange={handleChange}
                                        />
                                        $0 - $5
                                    </label>
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox"
                                            value="&price_greater_than=5&price_less_than=10"
                                            checked={selectedOption === "&price_greater_than=5&price_less_than=10"}
                                            onChange={handleChange}
                                        />
                                        $5 - $10
                                    </label>
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox"
                                            value="&price_greater_than=10&price_less_than=15"
                                            checked={selectedOption === "&price_greater_than=10&price_less_than=15"}
                                            onChange={handleChange}
                                        />
                                        $10 - $15
                                    </label>
                                ...
                                <li>
                                    <label>
                                        <input type="checkbox"
                                             value="&price_greater_than=15"
                                             checked={selectedOption === "&price_greater_than=15"}
                                             onChange={handleChange}
                                        />
                                        $15 +
                                    </label>
